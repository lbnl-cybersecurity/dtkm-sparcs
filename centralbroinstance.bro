...
redef Broker::endpoint_name = "central";
global msg_count = 0;
...
#	Broker::send_event("bro/central/my_event", Broker::event_args(centralremoveremote,to_addr("123.123.123.123"),"manual_revoke_from_central",network_time()));
